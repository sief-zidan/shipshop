...
const Shipments = ({ navigation }) => {
  ...
  const [selected_shipment, setselected_shipment] = useState({})
  ...
  async function get_data() {
    ...
    axios.post('https://camp-coding.tech/ship_shop/user/home/select_shipments.php', data_send).then(res => {
  ...
  function order_request(data, index) {
    ...
    setloading_request(load)
    let trip_data = data
    let ship_data = selected_shipment
